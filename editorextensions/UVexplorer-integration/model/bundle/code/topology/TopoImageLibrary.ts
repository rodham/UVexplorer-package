...
export class TopoImageLibrary {
	public static findImage(key: TopoImageKey): HTMLImageElement | undefined {
	...
	constructor() {
        ...
        this._isLoaded = false; // TODO ?? Added so TypeScript would compile
	}
	...
	private _findImage(key: TopoImageKey): HTMLImageElement | undefined{
		if (key != null) {

			var entry: TopoImageEntry | undefined;
