...
export class DeviceNodeUtil {
	public static getCategoryImage(deviceNode: DeviceNode): HTMLImageElement | undefined{

		let result: HTMLImageElement | undefined = undefined;
	...
	private static findCategoryImage(category: string): HTMLImageElement | undefined {
	...
	public static getVendorImage(deviceNode: DeviceNode): HTMLImageElement | undefined {
	...
	private static getPrimaryDeviceCategory(categories: DeviceCategories): string {
		let OrderedPrimaryCategories = [
			"firewall", "router", "switch", "printer", "wireless-controller", "wireless-ap",
			"virtual-server", "virtual-switch", "virtual-port-group", "ip-phone",
			"ip-phone-manager", "server", "workstation", "windows", "windows-server", "ip_camera_cctv"
		];
	...
	public static getStatusIconImage(deviceNode: DeviceNode): HTMLImageElement | undefined{
	...
	public static getStatusBackgroundImage(deviceNode: DeviceNode): HTMLImageElement | undefined {
